...
when number = 5 then message = "This is the freedom lover.  The number five is an intellectual vibration.  These are the 'idea' people with a love of variety and the ability to adapt to most situations.  Ruled by Mercury."
...
else message = "Wait!  Your birth path number isn't 1-9!!"
end
end
