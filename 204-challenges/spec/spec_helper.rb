...
module SpecHelper
  ...
  NUMEROLOGY = {
    ...
    "5" => { birthdate: "12191999", message: "This is the freedom lover.  The number five is an intellectual vibration.  These are the 'idea' people with a love of variety and the ability to adapt to most situations.  Ruled by Mercury." },
